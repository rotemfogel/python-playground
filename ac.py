...
class ActiveCampaignCampaignOperator(ActiveCampaignBaseOperator):
    ...
    def __init__(self,
                 api_prefix: str,
                 data_point: str,
                 execution_timeout: timedelta = timedelta(minutes=5),  # based on a max of 24s, of 524 runs
                 *args,
                 **kwargs):
        super().__init__(api_prefix=api_prefix, data_point=data_point, execution_timeout=execution_timeout, *args,
                         **kwargs)
...
class ActiveCampaignDeltaOperator(ActiveCampaignBaseOperator):
    ...
    def __init__(self,
                 ...
                 api_action: str = None,
                 sort_key: str = None,
                 execution_timeout: timedelta = timedelta(minutes=5),  # based on a max of 22s, of 526 runs
                 *args,
                 **kwargs):
        super().__init__(api_prefix=api_prefix, data_point=data_point, api_action=api_action, sort_key=sort_key,
                         execution_timeout=execution_timeout, last_ts_ind=True, *args, **kwargs)
    ...
    def execute(self, context: dict):
        ...
        for campaign in campaign_pairs:
            ...
            while True:
                print('getting data for campaign: {}, message: {}, offset: {}, limit: {}'.format(
    ...
    def _save_last_ts(self, campaign_id: str, last_ts: str) -> None:
        ...
        print('setting active_campaign_last_ts -> {}'.format(json.dumps(self._active_campaign_last_ts)))
...
if __name__ == '__main__':
    ...
    for task in active_campaign_tasks:
        ...
        table = task_id
        ac_api = ActiveCampaignDeltaOperator(task_id=f'{task_id}_api',
