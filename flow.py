...
for project in projects:
    for table, secret in project.items():
        ...
        delighted_conn = Connection(conn_id=task_id,
                                    conn_type='http',
        ...
        while payload['page'] < 2:
            print('{}: Sending payload: {} to endpoint {}'.format(task_id, payload, endpoint))
            ...
            if (response.status_code == 200) | (response.status_code == 404):
                ...
                error_msg = 'Got response status code {} for payload: {} to endpoint {}'.format(
