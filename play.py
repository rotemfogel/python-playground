...
tables_to_monitor = {
    "active_users": {"column": "created_at", "condition": "date_>=(sysdate-2)"},
    "authors": {"column": "created_on"},
    "comments": {"column": "created_on"},
    "content_tags": {"column": "updated_on", "condition": "updated_on<=(sysdate+1)"},
    "contents_agg": {"column": "created_at"},
    "email_events": {
        "column": "send_time",
        "condition": "date_>=(sysdate-2)",
        "database": "db_layer",
    },
    "marketing_attribution": {"column": "sub_date_time"},
    "page_events": {
        "column": "ts",
        "condition": "date_>=(sysdate-2)",
        "database": "db_layer",
    ...
    "paying_users": {"column": "account_created_date"},
    "portfolios": {"column": "created_on"},
    "session": {"column": "session_start", "target": 26},
    "sessions_ab_test": {"column": "session_end"},
    "subscription_events": {"column": "ts", "condition": "date_>=(sysdate-2)"},
    "user_author_research_discounts": {"column": "created_at"},
    "user_followings": {"column": "created_on"},
    "user_registration_trackings": {"column": "registered"},
    "users": {"column": "created_at"},
    "visitors_aggregation": {"column": "date_"},
    "zuora_subscriptions": {"column": "subscription_start_date"},
}
...
sql_templates_dir = (
    "/home/rotem/dev/workspace/seekingalpha/data-management-airflow/dags/sql_template/"
)
...
if __name__ == "__main__":
    ...
    _assert(
        _build_path("test_for_sapi/mp_kpi_dash_interim"), "for_sapi/mp_kpi_dash_interim"
    )
    _assert(
        _build_path("poc_for_sapi/mp_kpi_dash_interim"), "for_sapi/mp_kpi_dash_interim"
    )
