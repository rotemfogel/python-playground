...
configuration = [
    ...
    },
    {
        ...
        'params': {
            ...
            'columns': ['product_id', 'date_', 'paying_subscriptions', 'free_trial_subscriptions',
                        'paying_subscriptions_pending_cancelation', 'paying_annual_subscriptions', 'paying_mrr',
                        'checkout_conversion_rate_28day_ma', 'free_trial_conversion_rate_28day_ma', 'followers',
...
if __name__ == "__main__":
    ...
    pprint(list(filter(lambda x: x['task_id'] == 'page_events_records_ratio', configuration))[-1])
