...
dependencies_params = {
    'mariadb.marketplace_wildcard_banners': {'depends_on_hourly': True, 'timeout': 3 * 60 * 60},
    'mariadb.marketplace_banner_campaigns': {'depends_on_hourly': True, 'timeout': 3 * 60 * 60},
}
